...
[![](http://cranlogs.r-pkg.org/badges/daymetr)](http://cran.rstudio.com/web/packages/daymetr/index.html)
...
path | path where to store the data when not used internally, defaults to the current working directory
